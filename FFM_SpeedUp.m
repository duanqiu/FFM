function [MyV1,MyV2,R] = FFM_SpeedUp(im,v1,v2)
addpath('./BM3D');
addpath('./pyramid')
...
[I1, R1] = FractionalEnhence2(im_half,v1,v2);
I1 = imresize(tsmooth(I1,0.015,3),[ rr, cc]);
hsv = rgb2hsv(im);
...
I_f_half = imresize( I_f, 0.5 );
[I2, R2] = FractionalEnhence2(I_f_half,v1,v2);
I2 = imresize(tsmooth(I2,0.015,3),[ rr, cc]);
hsv = rgb2hsv(I_f);
